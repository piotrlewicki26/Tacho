  ...
  <div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
      <thead class="text-muted small">
        <tr><th>Imię i nazwisko</th><th>E-mail</th><th>Firma</th><th>Rola</th><th>Aktywny</th><th>Ostatnie logowanie</th><?php if ($isSuperAdmin): ?><th></th><?php endif; ?></tr>
      </thead>
      <tbody>
        ...
        <?php endforeach; ?>
        <?php if (empty($users)): ?>
        <tr><td colspan="<?= $isSuperAdmin ? 7 : 6 ?>" class="text-muted text-center py-4">Brak użytkowników</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
